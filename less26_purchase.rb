...
sub_summ = Hash.new  # собирает в хэш  сумму*количество по каждой покупке
sub_itog = Hash.new  # собирает в хэш  сумму и количество по каждой покупке
...
puts cart
puts "Result summa of your purchases:"
puts itog_summ
